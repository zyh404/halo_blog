...
<head>
    ...
    <title>${blog_title!} Website map</title>
...
<body>
<h2 style="text-align: center; margin-top: 20px">${blog_title!} website map </h2>
...
<div id="footer">
    The file is generated by <a href="${blog_url!}" title="${blog_title!}">${blog_title!}</a>
</div>
</body>
</html>
</#compress>